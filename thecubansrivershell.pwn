//---------------------------------------------------------
//
// The Cubans Rivershell v0 by treebtc - 2006-2036
//
//---------------------------------------------------------

#include <a_samp>
#include <a_players>		// se añade librerias que nunca se usan
#include <a_actor>
#include <a_http>
#include <datagram>
#include <file>
...
//Se añade color blanco y negro
#define OBJECTIVE_VEHICLE_WHITE			0xFFFFFFFF
#define OBJECTIVE_VEHICLE_BLACK			0x00000000
#define OBJECTIVE_VEHICLE_GREEN 		2
#define OBJECTIVE_VEHICLE_BLUE 			1
#define TEAM_GREEN 						1
#define TEAM_BLUE 						2
//Se añade el equipo blanco y el equipo negro
#define TEAM_BLACK						3
#define TEAM_WHITE						4
#define OBJECTIVE_COLOR 				0xE2C063FF
#define TEAM_GREEN_COLOR 				0x77CC77FF
#define TEAM_BLUE_COLOR 				0x7777DDFF
//Se añade colores de grupo blanco y negro
#define TEAM_BLACK_COLOR 				0x00000000
#define TEAM_WHITE_COLOR				0xFFFFFFFF
...
//Se añade el estado compra y venta que servirá para establecer nuestra funcion compra venta de objetos
#define SPECTATE_STATE_BUYSELL			3

#define SPECTATE_MODE_NONE           	0
#define SPECTATE_MODE_PLAYER           	1
#define SPECTATE_MODE_VEHICLE           2
//Se añade el modo de espectativa BUY/SELL. AUN NO SE USA EN NINGUN SITIO.
#define SPECTATE_MODE_BUYSELL			3
...
{
	print("\n----------------------------------");
	print("  The Cubans by treebtc 2006-2036\n");
	print("----------------------------------\n");
}
//---------------------------------------------------------
